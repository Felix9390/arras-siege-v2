                ...
                const getminimap = (() => {
                  ...
                  if (room.wall)
                    for (let loc of room.wall) {
                      ...
                      o.SIZE = (room.width / room.xgrid) / 2 - 1.5;
                    }
                  var sanc_count = 3
                  if (room.sanc)
...
var gameloop = (() => {
    ...
    let collide = (() => {
        ...
        function reflectcollide(wall, bounce) {
          ...
          let bounceBy = bounce.type === 'tank' ? 1.0 : bounce.type === ('miniboss', 'bullet', 'trap') ? 2.5 : 0.1
        ...
        if (instance.type == "tank" && other.type != instance)
          advancedcollide(instance, other, true, true);
            ...
            if (instance.settings.hitsOwnType === other.settings.hitsOwnType) {
                ...
                case "tank":
                    if (instance.type === "tank" && other.type === "tank") firmcollide(instance, other); break;
                case "boss":
                    if (instance.type === "miniboss" && other.type === "miniboss") firmcollide(instance, other); break;
                case "trap":
      ...
      if (timer == 30) {
        ...
        for (let i = 0; i < 120; i++) {
          if (i <= 6) {
            switch (wave) {
              case i:
                choice = [[Class.elite_sprayer, Class.elite_destroyer, Class.elite_gunner, Class.elite_spawner, Class.elite_battleship], 1 + (i * .4), 'a', 'nest'];  
                break;
            }
          } else if (i >= 7 & i <= 12) {
              switch (wave) {
                case i:
                  choice = [[Class.palisade, Class.summon, Class.elite_skimmer, Class.nestkeeper], 1 + (i * 0.4), 'a', 'nest'];
              ...
              switch (wave) {
                case i:
                  choice = [[Class.lucius, Class.dacia, Class.xenon], 1, 'a', 'nest'];
                  sockets.broadcast("The World Tremors as the Celestials we're born anew!")
                  break;
              ...
              switch (wave) {
                case i:
                  choice = [[Class.lucius, Class.dacia, Class.xenon], 1 * Math.floor(Math.random() * 2), 'a', 'nest'];
                  break;
              ...
              switch (wave) {
                case i:
                  choice = [[Class.elite_sprayer, Class.elite_destroyer, Class.elite_gunner, Class.elite_spawner, Class.elite_battleship, Class.elite_swarmer, Class.elite_twin, Class.elite_pounder], 1 + (i * .2), 'a', 'nest'];
                  break;
              ...
              switch (wave) {
                case i:
                  choice = [[Class.nephele, Class.okeanos, Class.phobos], 1 + Math.floor(Math.random() * 8), 'a', 'nest'];
                  break;
              ...
              switch (wave) {
                case i:
                  choice = [[Class.ragnarok, Class.kronos].sort(() => 0.5 * Math.random), 1 * Math.random() * 1, 'a', 'nest'];
                  break;
              ...
              switch (wave) {
                case i:
                  choice = [[Class.elite_sprayer, Class.elite_destroyer, Class.elite_gunner, Class.elite_spawner, Class.elite_battleship, Class.elite_swarmer, Class.elite_twin, Class.elite_pounder, Class.palisade, Class.summon, Class.elite_skimmer, Class.nestkeeper, Class.nephele, Class.okeanos, Class.phobos, Class.lucius, Class.dacia, Class.xenon, Class.ragnarok, Class.kronos], 16, 'a', 'nest'];
                  break;
